// client/src/components/ParentModule/pages/GradesPage.tsx
...
export function GradesPage() {
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            ...
            setError(null);
            try {
                // Panggilan API baru untuk mendapatkan daftar periode yang tersedia
                const periodsResponse = await axios.get(
                    `${import.meta.env.VITE_API_URL}/api/account/santri/available-rapor-periods`,
