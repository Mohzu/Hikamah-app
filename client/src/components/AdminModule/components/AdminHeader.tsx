      ...
      <div className="flex items-center justify-between px-6 py-4 lg:px-10">
        <div className="flex items-center flex-1">
          ...
          <div className="ml-4 lg:ml-0 flex items-center flex-1">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-bold text-gray-900 mb-1">{user?.username || user?.nama_pengguna || 'Admin'}</h1>
              <div className="flex items-center space-x-4">
                <p className="text-sm text-gray-600 flex items-center">
                  <User size={16} className="mr-1.5 text-blue-600" />
                  <span className="font-medium">{user?.peran || 'Admin'}</span>
                </p>
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl px-4 py-2.5 border border-gray-200 shadow-sm">
            <div className="w-8 h-8 bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl flex items-center justify-center mr-3">
